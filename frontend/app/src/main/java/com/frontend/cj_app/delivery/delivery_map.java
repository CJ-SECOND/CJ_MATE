    ...
    public void onMapReady(@NonNull NaverMap naverMap) {
        ...
        AddressApi.getCouryToAddress(request).enqueue(new Callback<CouryToAddress_Response>() {
            ...
            public void onResponse(Call<CouryToAddress_Response> call, Response<CouryToAddress_Response> response) {
                ...
                String recvAddress = recv_to_addr.get(0).getCouryToAddress();
                ...
                for(Coury_map coury : recv_to_addr) {
                    ...
                    un_clear_listview.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                        ...
                        public void onItemClick(AdapterView parent, View v, int position, long id){
                            ...
                            Intent intent = new Intent(getApplicationContext(), delivery_check.class);
                            intent.putExtra("recvAddr", mapListAdapter1.getItem(position).getCouryToAddress());
                            intent.putExtra("condition", mapListAdapter1.getItem(position).getCouryCondition());
                            intent.putExtra("recvName", mapListAdapter1.getItem(position).getCouryToName());
