package com.frontend.cj_app.photo;
...
import com.frontend.cj_app.common.model.DeviceOrientation;
...
public class photo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = findViewById(R.id.btn_photo_next);
    ...
    private CameraDevice.StateCallback deviceStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(CameraDevice camera, int error) {
            Toast.makeText(photo.this, "카메라를 열지 못했습니다.", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private CameraCaptureSession.StateCallback mSessionPreviewStateCallback = new CameraCaptureSession.StateCallback() {
        ...
        public void onConfigureFailed(@NonNull CameraCaptureSession session) {
            Toast.makeText(photo.this, "카메라 구성 실패", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private class SaveImageTask extends AsyncTask<Bitmap, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(photo.this, "사진을 저장하였습니다.", Toast.LENGTH_SHORT).show();
        }
